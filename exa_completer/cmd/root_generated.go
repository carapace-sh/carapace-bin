...
func init() {
	...
	rootCmd.Flags().String("colo[u]r", "", "when to use terminal colours (always, auto, never)")
	rootCmd.Flags().Bool("colo[u]r-scale", false, "highlight levels of file sizes distinctly")
