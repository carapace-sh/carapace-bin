...
func init() {
	...
	rootCmd.Flags().String("exclude-identifier", "", "Hide entries with the specified syslog identifier")
	...
	rootCmd.Flags().String("image-policy", "", "Specify disk image dissection policy")
	rootCmd.Flags().String("interval", "", "Time interval for changing the FSS sealing key")
	rootCmd.Flags().String("invocation", "", "Show logs from the matching invocation ID")
	...
	rootCmd.Flags().Bool("list-invocations", false, "Show invocation IDs of specified unit")
	rootCmd.Flags().Bool("list-namespaces", false, "Show list of journal namespaces")
	...
	rootCmd.Flags().String("synchronize-on-exit", "", "Synchronize unwritten journal messages to disk on exit")
	rootCmd.Flags().Bool("system", false, "Show the system journal")
	rootCmd.Flags().Bool("truncate-newline", false, "Truncate entries by first newline character")
