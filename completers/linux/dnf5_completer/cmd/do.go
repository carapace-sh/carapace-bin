...
func init() {
	...
	doCmd.Flags().Bool("advisory", false, "Limit to packages specified by advisory")
	...
	doCmd.Flags().String("bz", "", "Limit to packages specified by Bugzilla ID")
	doCmd.Flags().String("cve", "", "Limit to packages specified by CVE ID")
	...
	doCmd.Flags().String("severity", "", "Limit to packages specified by advisory severity")
