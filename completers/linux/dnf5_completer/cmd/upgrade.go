...
func init() {
	...
	upgradeCmd.Flags().Bool("advisory", false, "Limit to packages specified by advisory")
	...
	upgradeCmd.Flags().String("bz", "", "Limit to packages specified by Bugzilla ID")
	upgradeCmd.Flags().String("cve", "", "Limit to packages specified by CVE ID")
	...
	upgradeCmd.Flags().String("severity", "", "Limit to packages specified by advisory severity")
