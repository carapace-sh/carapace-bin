...
func init() {
	...
	rootCmd.Flags().Bool("allow-vendor-change", false, "Allow automatic package replacements from different vendors")
	...
	rootCmd.Flags().Bool("no-allow-vendor-change", false, "Do not allow automatic package replacements from different vendors")
