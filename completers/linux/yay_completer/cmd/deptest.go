...
func init() {
	...
	deptestCmd.Flags().Bool("disable-sandbox", false, "disable sandbox features used for the downloader process")
	deptestCmd.Flags().Bool("disable-sandbox-filesystem", false, "disable the filesystem part of the downloader process sandbox")
	deptestCmd.Flags().Bool("disable-sandbox-syscalls", false, "disable the syscalls part of the downloader process sandbox")
