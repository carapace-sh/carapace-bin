...
var address_flushCmd = &cobra.Command{
	Use:   "flush",
	Short: "flush protocol addresses",
	Run:   func(cmd *cobra.Command, args []string) {},
}

func init() {
	carapace.Gen(address_flushCmd).Standalone()

	addressCmd.AddCommand(address_flushCmd)

	carapace.Gen(address_flushCmd).PositionalAnyCompletion(
