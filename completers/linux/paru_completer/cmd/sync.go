...
func init() {
	...
	syncCmd.Flags().CountP("info", "i", "view package information (-ii for extended information)")
	...
	syncCmd.Flags().CountP("nodeps", "d", "skip dependency version checks (-dd to skip all checks)")
