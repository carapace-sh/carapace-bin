...
func init() {
	...
	rootCmd.Flags().BoolP("end-time", "e", false, "show end time for (dis)charge")
	...
	rootCmd.Flags().StringP("format-time", "F", "", "specify end-time format string")
	...
	rootCmd.Flags().BoolP("remaining-time", "r", false, "show remaining time for (dis)charge")
