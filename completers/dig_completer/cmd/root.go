	...
	return carapace.ActionMultiParts("=", func(c carapace.Context) carapace.Action {
		...
		case 0:
			return carapace.ActionValuesDescribed(
				...
				"+cmd",
				"This  option  toggles the printing of the initial comment in the output.",
				"+comments",
				"This option toggles the display of some comment lines in the output.",
				"+cookie=",
				...
				"+dnssec",
				"This option requests that DNSSEC records be sent by setting the DNSSEC OK (DO) bit in the OPT record.",
				"+domain=",
				"This  option  sets the search list to contain the single domain somename.",
				"+dscp=",
				"This option sets the DSCP code point to be used when sending the query.",
				"+edns=",
				...
				"+fail",
				"This  option  indicates  that named should try [or not try] the next server if a SERVFAIL is received.",
				"+header-only",
				"This option sends a query with a DNS header without a question section.",
				"+identify",
				"This option shows [or does not show] the IP address and port number that supplied the answer.",
				"+idnin",
				...
				"+keepopen",
				"This option keeps [or does not keep] the TCP socket open between queries.",
				"+mapped",
				"This option allows [or does not allow] mapped IPv4-over-IPv6 addresses to be used.",
				"+multiline",
				"This  option  prints [or does not print] records.",
				"+ndots=",
				...
				"+retry=",
				"This option sets the number of times to retry UDP queries to server to T instead of the default, 2.",
				"+rrcomments",
				"This option toggles the display of per-record comments in the output.",
				"+search",
				...
				"+split=",
				"This option splits long hex- or base64-formatted fields in resource records into chunks of W characters.",
				"+stats",
				...
				"+tries=",
				"This option sets the number of times to try UDP queries to server to T instead of the default, 3.",
				"+trusted-key=",
				"This option formerly specified trusted keys for use with dig +sigchase.",
				"+ttlid",
				"This option displays [or does not display] the TTL when printing the record.",
				"+ttlunits",
				"This  option  displays  [or  does  not  display]  the TTL in friendly human-readable time units",
				"+unexpected",
				"This option accepts [or does not accept] answers from unexpected sources.",
				"+unknownformat",
				"This option prints all RDATA in unknown RR type presentation format (RFC 3597).",
				"+vc",
				"This option uses [or does not use] TCP when querying name servers.",
				"+yaml",
				"When enabled, this option prints the responses in a detailed YAML format.",
				"+zflag",
