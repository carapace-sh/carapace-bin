...
func init() {
	...
	rootCmd.Flags().Bool("default-config", false, "Print default config to standard output")
	...
	rootCmd.Flags().String("themes-dir", "", "Path to a custom themes directory")
	...
	carapace.Gen(rootCmd).FlagCompletion(carapace.ActionMap{
		...
		"themes-dir": carapace.ActionDirectories(),
	})
}
