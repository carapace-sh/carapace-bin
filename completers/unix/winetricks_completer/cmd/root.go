...
func init() {
	...
	rootCmd.Flags().String("gui", "", "Show gui diagnostics even when driven by commandline (or set to kdialog or zenity)")
	...
	rootCmd.Flags().Bool("optin", false, "Opt in to reporting which verbs you use to the Winetricks maintainers")
	rootCmd.Flags().Bool("optout", false, "Opt out of reporting which verbs you use to the Winetricks maintainers")
	...
	rootCmd.Flags().Bool("update-rollback", false, "Rollback the last self update")
	...
	carapace.Gen(rootCmd).FlagCompletion(carapace.ActionMap{
		"gui": carapace.ActionValues("kdialog", "zenity"),
	})
