...
func init() {
	...
	rootCmd.Flags().BoolS("fullPaths", "fullPaths", false, "Show full paths")
	rootCmd.Flags().BoolS("mayDie", "mayDie", false, "Process may die during sampling")
	rootCmd.Flags().BoolS("wait", "wait", false, "Wait for the process to start")
