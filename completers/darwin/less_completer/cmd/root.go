...
func init() {
	...
	rootCmd.Flags().BoolS("Y", "Y", "", "Max forward scroll (same as -y)")
	...
	rootCmd.Flags().BoolS("x", "x", "", "Tab stops")
	rootCmd.Flags().BoolS("y", "y", "", "Max forward scroll")
	rootCmd.Flags().BoolS("z", "z", "", "Window size")
}
