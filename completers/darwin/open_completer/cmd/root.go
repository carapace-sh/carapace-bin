...
func init() {
	...
	rootCmd.Flags().String("arch", "", "Open with the given cpu architecture type and subtype")
	rootCmd.Flags().StringP("bundle", "b", "", "Open the file with the specified bundle identifier")
	rootCmd.Flags().String("env", "", "Add an environment variable to the launched process (VAR=value)")
	...
	rootCmd.Flags().String("stderr", "", "Launch the application with stderr connected to PATH")
	rootCmd.Flags().String("stdin", "", "Launch the application with stdin connected to PATH")
	rootCmd.Flags().String("stdout", "", "Launch the application with stdout connected to PATH")
