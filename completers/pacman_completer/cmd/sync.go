...
func init() {
	...
	syncCmd.Flags().StringSlice("ignore", []string{}, "ignore a package upgrade")
	syncCmd.Flags().StringSlice("ignoregroup", []string{}, "ignore a group upgrade")
	...
	syncCmd.Flags().StringSlice("overwrite", []string{}, "overwrite conflicting files")
