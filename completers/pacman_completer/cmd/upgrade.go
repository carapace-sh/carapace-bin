...
func init() {
	...
	upgradeCmd.Flags().StringSlice("ignore", []string{}, "ignore a package upgrade")
	upgradeCmd.Flags().StringSlice("ignoregroup", []string{}, "ignore a group upgrade")
	...
	upgradeCmd.Flags().StringSlice("overwrite", []string{}, "overwrite conflicting files")
