...
func init() {
	repackCmd.Flags().BoolP("a", "a", false, "pack everything in a single pack")
	repackCmd.Flags().BoolP("A", "A", false, "same as -a, and turn unreachable objects loose")
	...
	repackCmd.Flags().BoolP("d", "d", false, "remove redundant packs, and run git-prune-packed")
	repackCmd.Flags().BoolP("f", "f", false, "pass --no-reuse-delta to git-pack-objects")
	repackCmd.Flags().BoolP("F", "F", false, "pass --no-reuse-object to git-pack-objects")
	...
	repackCmd.Flags().BoolP("n", "n", false, "do not run git-update-server-info")
