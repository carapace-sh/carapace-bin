...
func init() {
	...
	rootCmd.Flags().StringSlice("file-name", []string{}, "Specify the name to display for a file")
	rootCmd.Flags().BoolP("force-colorization", "f", false, "Alias for '--decorations=always --color=always'")
	rootCmd.Flags().BoolP("help", "h", false, "Print help")
	rootCmd.Flags().StringSliceP("highlight-line", "H", []string{}, "Highlight lines N through M")
	rootCmd.Flags().StringSlice("ignored-suffix", []string{}, "Ignore extension")
	...
	rootCmd.Flags().StringSliceP("line-range", "r", []string{}, "Only print the lines from N to M")
