...
func init() {
	...
	image_buildCmd.Flags().IntP("memory", "m", 0, "Memory limit")
	image_buildCmd.Flags().Int("memory-swap", 0, "Swap limit equal to memory plus swap: '-1' to enable unlimited swap")
	...
	image_buildCmd.Flags().Int("shm-size", 0, "Size of /dev/shm")
