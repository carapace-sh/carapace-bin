...
func init() {
	...
	swarm_initCmd.Flags().String("default-addr-pool", "", "default address pool in CIDR format")
	swarm_initCmd.Flags().Uint32("default-addr-pool-mask-length", 24, "default address pool subnet mask length")
	...
	swarm_initCmd.Flags().Uint64("snapshot-interval", 10000, "Number of log entries between Raft snapshots")
	swarm_initCmd.Flags().Int64("task-history-limit", 5, "Task history retention limit")
