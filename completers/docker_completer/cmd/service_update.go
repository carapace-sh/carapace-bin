...
func init() {
	...
	service_updateCmd.Flags().Int("limit-cpu", 0, "Limit CPUs")
	service_updateCmd.Flags().Int("limit-memory", 0, "Limit Memory")
	...
	service_updateCmd.Flags().Int("reserve-cpu", 0, "Reserve CPUs")
	service_updateCmd.Flags().Int("reserve-memory", 0, "Reserve Memory")
