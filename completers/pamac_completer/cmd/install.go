...
import (
	...
	"github.com/rsteube/carapace-bin/pkg/actions/os/pacman"
...
func init() {
	...
	carapace.Gen(installCmd).PositionalAnyCompletion(pacman.ActionPackages(pacman.PackageOption{})) // TODO groups as well
}
