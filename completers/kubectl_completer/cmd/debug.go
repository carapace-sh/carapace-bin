...
func init() {
	...
	debugCmd.Flags().StringArray("env", []string{}, "Environment variables to set in the container.")
	...
	debugCmd.Flags().StringArray("set-image", []string{}, "When used with '--copy-to', a list of name=image pairs for changing container images, similar to how 'kubectl set image' works.")
