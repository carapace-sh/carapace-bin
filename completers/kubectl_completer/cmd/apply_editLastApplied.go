...
func init() {
	...
	apply_editLastAppliedCmd.Flags().String("validate", "strict", "Must be one of: strict (or true), warn, ignore (or false).")
	apply_editLastAppliedCmd.Flags().Bool("windows-line-endings", false, "Defaults to the line ending native to your platform.")
	apply_editLastAppliedCmd.Flag("validate").NoOptDefVal = "strict"
