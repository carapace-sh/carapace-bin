...
func init() {
	...
	mr_note_createCmd.Flags().String("old-line", "", "Line in the old version, for commenting on a removed line.")
	...
	mr_note_createCmd.Flags().Bool("resolvable", false, "Create the note as a resolvable discussion thread. Set to false to create a non-resolvable note.")
