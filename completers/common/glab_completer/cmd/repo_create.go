...
func init() {
	...
	repo_createCmd.Flags().String("defaultBranch", "", "Branch name for the new project, overriding both the GitLab instance default and your local git configuration.")
	repo_createCmd.Flags().StringP("description", "d", "", "Description of the new project. Set to \"-\" to open an editor.")
