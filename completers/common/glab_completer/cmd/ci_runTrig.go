...
func init() {
	...
	ci_runTrigCmd.Flags().StringSlice("variables", nil, "Pass variables to pipeline in the format <key>:<value>. Multiple variables can be comma-separated or specified by repeating the flag.")
