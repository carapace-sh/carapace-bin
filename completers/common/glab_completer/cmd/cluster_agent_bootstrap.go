...
func init() {
	...
	cluster_agent_bootstrapCmd.Flags().String("flux-environment-flux-resource-path", "", "Flux resource path of the environment for FluxCD.")
	cluster_agent_bootstrapCmd.Flags().String("flux-environment-name", "", "Name of the environment for FluxCD.")
	cluster_agent_bootstrapCmd.Flags().String("flux-environment-namespace", "", "Kubernetes namespace of the environment for FluxCD.")
	...
	cluster_agent_bootstrapCmd.Flags().String("flux-source-type", "", "Source type of the flux-system, like Git, OCI, or Helm.")
	...
	cluster_agent_bootstrapCmd.Flags().String("helm-release-filepath", "", "File path within the GitLab Agent project to commit the Flux HelmRelease to.")
