...
func init() {
	...
	docCmd.Flags().Bool("releases", false, "Rust Release Notes")
	...
	docCmd.Flags().Bool("rustc-docs", false, "The API documentation for the Rust compiler and other toolchain components")
