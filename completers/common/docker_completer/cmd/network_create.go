...
func init() {
	...
	network_createCmd.Flags().Bool("ipv4", false, "Enable or disable IPv4 address assignment")
	network_createCmd.Flags().Bool("ipv6", false, "Enable or disable IPv6 address assignment")
