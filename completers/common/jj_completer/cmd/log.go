...
func init() {
	...
	logCmd.Flags().StringSliceP("revision", "r", []string{"@ | ancestors(immutable_heads().., 2) | heads(immutable_heads())"}, "Which revisions to show")
	logCmd.Flags().StringSlice("revisions", []string{"@ | ancestors(immutable_heads().., 2) | heads(immutable_heads())"}, "Which revisions to show")
