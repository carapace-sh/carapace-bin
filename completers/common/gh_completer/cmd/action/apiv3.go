...
var v3Paths map[string][]string = map[string][]string{
	"delete": {
		...
		"repos/{owner}/{repo}/tags/protection/{tag_protection_id}", "Delete a tag protection state for a repository",
	...
	"get": {
		...
		"emojis", "Get emojis",
		"enterprise-installation/{enterprise_or_org}/server-statistics", "Get GitHub Enterprise Server statistics",
		...
		"enterprises/{enterprise}/actions/permissions/workflow", "Get default workflow permissions for an enterprise",
		...
		"repos/{owner}/{repo}/actions/oidc/customization/sub", "Get the opt-out flag of an OIDC subject claim customization for a repository",
		...
		"repos/{owner}/{repo}/tags/protection", "List tag protection states for a repository",
	...
	"post": {
		...
		"repos/{owner}/{repo}/tags/protection", "Create a tag protection state for a repository",
	...
	"put": {
		...
		"enterprises/{enterprise}/actions/oidc/customization/issuer", "Set the GitHub Actions OIDC custom issuer policy for an enterprise",
		...
		"enterprises/{enterprise}/actions/permissions/workflow", "Set default workflow permissions for an enterprise",
		...
		"repos/{owner}/{repo}/actions/oidc/customization/sub", "Set the opt-out flag of an OIDC subject claim customization for a repository",
