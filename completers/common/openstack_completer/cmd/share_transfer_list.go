...
func init() {
	...
	share_transfer_listCmd.Flags().String("resource_id", "", "Filter share transfers by resource ID.")
	share_transfer_listCmd.Flags().String("resource_type", "", "Filter share transfers by resource type, which can be share.")
	...
	share_transfer_listCmd.Flags().String("sort_dir", "", "Sort direction, available values are ('asc', 'desc').")
	share_transfer_listCmd.Flags().String("sort_key", "", "Key to be sorted, available keys are ('id', 'resource_type', 'resource_id', 'name', 'source_project_id', 'destination_project_id', 'created_at', 'expires_at').")
	share_transfer_listCmd.Flags().String("source_project_id", "", "Filter share transfers by ID of the Project that initiated the transfer.")
