...
func init() {
	...
	share_lock_createCmd.Flags().String("reason", "", "Reason for the resource lock.")
	share_lock_createCmd.Flags().String("resource_action", "", "Action to lock on the resource (default=\"delete\")")
