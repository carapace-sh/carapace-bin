...
func init() {
	...
	share_lock_listCmd.Flags().String("lock-context", "", "Filter resource locks by context.")
	...
	share_lock_listCmd.Flags().String("resource", "", "Filter resource locks for a resource by ID, specify --resource-type to look up by name.")
	share_lock_listCmd.Flags().String("resource-action", "", "Filter resource locks by resource action.")
	share_lock_listCmd.Flags().String("resource-type", "", "Filter resource locks by type of resource.")
	...
	share_lock_listCmd.Flags().String("sort-dir", "", "Sort direction, available values are ('asc', 'desc').")
	share_lock_listCmd.Flags().String("sort-key", "", "Key to be sorted, available keys are ('id', 'created_at', 'updated_at', 'resource_id', 'resource_type', 'resource_action', 'lock_reason').")
