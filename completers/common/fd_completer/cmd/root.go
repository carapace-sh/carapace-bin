...
func init() {
	...
	rootCmd.Flags().String("change-newer-than", "", "alias for --changed-within")
	rootCmd.Flags().String("change-older-than", "", "alias for --changed-before")
	...
	rootCmd.Flags().String("ignore-contain", "", "Ignore directories containing the named entry")
	...
	rootCmd.Flags().String("newer", "", "alias for --changed-within")
	...
	rootCmd.Flags().String("older", "", "alias for --changed-before")
