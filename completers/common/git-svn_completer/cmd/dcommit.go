...
func init() {
	...
	dcommitCmd.Flags().Bool("dry-run", false, "Dry run")
	dcommitCmd.Flags().BoolP("edit", "e", false, "Edit commit message")
	dcommitCmd.Flags().BoolP("find-copies-harder", "l", false, "Find copies harder")
	...
	dcommitCmd.Flags().BoolP("merge-all", "M", false, "Merge all")
	...
	dcommitCmd.Flags().StringP("revision", "r", "", "Revision to commit to")
