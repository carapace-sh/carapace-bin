...
func init() {
	...
	carapace.Gen(revision_cherryPick_resolve_theirsCmd).FlagCompletion(carapace.ActionMap{
		"targets": carapace.ActionFiles(),
	})

	carapace.Gen(revision_cherryPick_resolve_theirsCmd).PositionalAnyCompletion(
