...
func init() {
	...
	carapace.Gen(revision_revert_resolve_theirsCmd).FlagCompletion(carapace.ActionMap{
		"targets": carapace.ActionFiles(),
	})

	carapace.Gen(revision_revert_resolve_theirsCmd).PositionalAnyCompletion(
