...
func init() {
	...
	carapace.Gen(revision_syncCmd).FlagCompletion(carapace.ActionMap{
		"root-file": carapace.ActionFiles(),
	})

	carapace.Gen(revision_syncCmd).PositionalCompletion(
		action.ActionRevisions(revision_syncCmd),
	)
}
