...
func init() {
	...
	rootCmd.Flags().String("date", "", "The timestamp in ISO-8601 extended offset date-time with optional time-zone format")
	...
	rootCmd.Flags().BoolP("keep-old-files", "k", false, "Do not overwrite existing files")
