...
func init() {
	...
	rootCmd.Flags().Bool("alpn", false, "Enable the ALPN TLS extension")
	...
	rootCmd.Flags().Bool("buffer", false, "Enable output buffering")
	...
	rootCmd.Flags().Bool("eprt", false, "Enable EPRT/LPRT for FTP")
	rootCmd.Flags().Bool("epsv", false, "Enable EPSV for FTP")
	...
	rootCmd.Flags().String("expand-data", "", "Expand variable data for POST")
	rootCmd.Flags().String("expand-url", "", "Expand variables in URL")
	rootCmd.Flags().String("expand-variable", "", "Expand variables in command line")
