...
func init() {
	...
	rootCmd.Flags().Bool("available", false, "Query available packages")
	...
	rootCmd.Flags().Bool("from-expression", false, "Interpret args as Nix expressions")
	...
	rootCmd.Flags().String("priority", "", "Set priority of derivations being installed")
