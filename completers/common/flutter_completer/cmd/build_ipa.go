...
func init() {
	...
	build_ipaCmd.Flags().String("flavor", "", "Build a custom app flavor as defined by platform-specific build setup.")
	...
	build_ipaCmd.Flags().Bool("no-obfuscate", false, "In a release build, this flag does not remove identifiers and replaces them with randomized values for the purposes of source code obfuscation.")
