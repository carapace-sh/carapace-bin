...
func init() {
	...
	rootCmd.Flags().StringS("env", "env", "", "environment in effect")
	rootCmd.Flags().StringS("errorurl", "errorurl", "", "pass URL to the linker for embedding in binary")
	...
	rootCmd.Flags().BoolS("l", "l", false, "disable inlining")
	rootCmd.Flags().StringS("lang", "lang", "", "Go language version source code expects")
	...
	rootCmd.Flags().BoolS("u", "u", false, "emit error line numbers")
