...
func init() {
	...
	panelCmd.Flags().StringP("override", "o", "", "Override individual kitty configuration options, can be specified multiple times. Syntax: name=value. For example: -o font_size=20")
