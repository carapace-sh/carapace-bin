...
func init() {
	...
	rootCmd.Flags().String("header-label", "", "Label to print on the header border")
	...
	rootCmd.Flags().String("id-nth", "", "Define item identity fields for cross-reload operations")
	...
	rootCmd.Flags().String("popup", "", "Start fzf in a popup window (requires tmux 3.3+ or Zellij 0.44+)")
