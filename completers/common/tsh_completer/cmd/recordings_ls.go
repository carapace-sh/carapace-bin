...
func init() {
	...
	recordings_lsCmd.Flags().StringP("format", "f", "text", "Format output (text, json, yaml). Defaults to 'text'.")
	...
	recordings_lsCmd.Flags().String("limit", "50", "Maximum number of recordings to show. Default 50.")
