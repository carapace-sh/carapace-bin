...
func init() {
	...
	kube_execCmd.Flags().String("kube-namespace", "", "Configure the default Kubernetes namespace.")
	kube_execCmd.Flags().StringP("namespace", "n", "", "Configure the default Kubernetes namespace.")
	...
	kube_execCmd.Flag("kube-namespace").Hidden = true
