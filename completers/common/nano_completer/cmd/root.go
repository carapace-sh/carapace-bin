...
func init() {
	...
	rootCmd.Flags().BoolP("historylog", "H", false, "Save & reload old search/replace strings")
	...
	rootCmd.Flags().BoolP("positionlog", "P", false, "Save & restore position of the cursor")
	...
	rootCmd.Flags().BoolP("solosidescroll", "1", false, "Scroll only the current line sideways")
