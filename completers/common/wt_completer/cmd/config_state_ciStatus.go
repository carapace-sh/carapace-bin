...
func init() {
	...
	config_state_ciStatusCmd.PersistentFlags().String("format", "text", "Output format (text, json) [default: text]")
	...
	carapace.Gen(config_state_ciStatusCmd).FlagCompletion(carapace.ActionMap{
