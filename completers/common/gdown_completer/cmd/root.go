...
import (
	...
	"github.com/carapace-sh/carapace-bin/completers/common/gdown_completer/cmd/actions"
...
func init() {
	...
	rootCmd.Flags().BoolP("continue", "c", false, "resume getting partially-downloaded files while skipping fully downloaded ones")
	...
	rootCmd.Flags().Bool("json", false, "list file or folder contents as a JSON array on stdout instead of downloading")
