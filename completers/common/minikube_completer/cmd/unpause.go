...
func init() {
	...
	unpauseCmd.Flags().StringSliceP("namespaces", "n", nil, "namespaces to unpause")
	unpauseCmd.Flags().StringP("output", "o", "", "Format to print stdout in. Options include: [text,json]")
