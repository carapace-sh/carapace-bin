...
func init() {
	...
	rootCmd.Flags().StringSlice("no-preserve", nil, "don't preserve the specified attributes")
	...
	rootCmd.Flags().StringSlice("preserve", nil, "preserve the specified attributes")
