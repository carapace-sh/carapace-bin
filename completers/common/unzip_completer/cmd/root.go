...
func init() {
	...
	rootCmd.Flags().StringS("I", "I", "", "specify a character encoding for UNIX and other archives")
	...
	rootCmd.Flags().StringS("O", "O", "", "specify a character encoding for DOS, Windows and OS/2 archives")
	...
	rootCmd.Flags().BoolS("UU", "UU", false, "ignore any Unicode fields")
	...
	rootCmd.Flags().BoolS("aa", "aa", false, "treat ALL files as text")
