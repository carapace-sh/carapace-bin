...
func init() {
	...
	buildCmd.Flags().Bool("check", false, "Check build configuration")
	...
	buildCmd.Flags().StringP("memory", "m", "0", "Set memory limit for the build container. Not supported by BuildKit.")
