...
func init() {
	...
	rootCmd.Flags().String("global-key-prev", "", "Previous")
	...
	rootCmd.Flags().String("global-key-stop", "", "Stop")
	...
	rootCmd.Flags().String("option", "", "A global option that is set for the duration of the program")
	rootCmd.Flags().String("options", "", "A global option that is set for the duration of the program")
