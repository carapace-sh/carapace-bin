...
func init() {
	...
	installCiTestCmd.Flags().Bool("no-audit", false, "skip audit")
	installCiTestCmd.Flags().Bool("no-bin-links", false, "skip symlinks for package executables")
	installCiTestCmd.Flags().Bool("no-fund", false, "skip funding message")
