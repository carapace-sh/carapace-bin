...
func init() {
	...
	rootCmd.Flags().BoolS("P", "P", false, "don't prepend a potentially unsafe path to sys.path")
	...
	rootCmd.Flags().Bool("help-all", false, "print complete help information and exit")
	rootCmd.Flags().Bool("help-env", false, "print help about Python environment variables and exit")
	rootCmd.Flags().Bool("help-xoptions", false, "print help about implementation-specific -X options and exit")
