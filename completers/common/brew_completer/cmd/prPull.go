...
func init() {
	...
	prPullCmd.Flags().String("artifact", "", "Download artifacts with the specified name (default: `bottles`).")
	...
	prPullCmd.Flags().String("committer", "", "Specify a committer name and email in `git`'s standard author format.")
	...
	prPullCmd.Flags().String("ignore-missing-artifacts", "", "Comma-separated list of workflows which can be ignored if they have not been run.")
	...
	prPullCmd.Flags().String("message", "", "Message to include when autosquashing revision bumps, deletions, and rebuilds.")
	...
	prPullCmd.Flags().String("root-url", "", "Use the specified <URL> as the root of the bottle's URL instead of Homebrew's default.")
	prPullCmd.Flags().String("root-url-using", "", "Use the specified download strategy class for downloading the bottle's URL instead of Homebrew's default.")
	prPullCmd.Flags().String("tap", "", "Target tap repository (default: `homebrew/core`).")
