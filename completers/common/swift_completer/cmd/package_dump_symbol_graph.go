...
func init() {
	...
	package_dumpSymbolGraphCmd.Flags().Bool("emit-extension-block-symbols", false, "Emit extension block symbols for extensions to external types")
	...
	package_dumpSymbolGraphCmd.Flags().Bool("omit-extension-block-symbols", false, "Emit extension block symbols for extensions to external types")
