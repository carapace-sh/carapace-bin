...
func init() {
	...
	workspace_platform_removeCmd.Flags().StringP("environment", "e", "", "The environment to remove the platform from. The platform is removed from the platforms defined inline on the environment")
