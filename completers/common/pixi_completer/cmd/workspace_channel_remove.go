...
func init() {
	...
	workspace_channel_removeCmd.Flags().Bool("no-hard-links", false, "Disallow hard links during package installation")
	...
	workspace_channel_removeCmd.Flags().String("tls-root-certs", "", "Which TLS root certificates to use: 'webpki' (bundled Mozilla roots) or 'system' (system store)")
