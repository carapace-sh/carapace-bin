...
func init() {
	...
	rootCmd.Flags().String("group-separator", "", "print SEP on line between matches with context")
	...
	rootCmd.Flags().Bool("no-group-separator", false, "do not print separator for matches with context")
