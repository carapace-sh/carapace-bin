...
func init() {
	...
	mergeFileCmd.Flags().String("marker-size", "", "conflict marker size")
	...
	mergeFileCmd.Flags().BoolP("quiet", "q", false, "do not warn about conflicts")
	mergeFileCmd.Flags().BoolP("stdout", "p", false, "send results to standard output instead of overwriting <current>")
