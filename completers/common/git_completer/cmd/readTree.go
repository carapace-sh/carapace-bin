...
func init() {
	...
	readTreeCmd.Flags().Bool("debug-unpack", false, "debug unpack-trees")
	...
	readTreeCmd.Flags().String("exclude-per-directory", "", "read exclude patterns from <gitignore> in each directory")
	...
	readTreeCmd.Flags().Bool("sparse-checkout", false, "opposite of --no-sparse-checkout")
	...
	readTreeCmd.Flags().BoolP("verbose", "v", false, "show the progress of checking files out")
