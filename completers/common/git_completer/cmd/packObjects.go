...
func init() {
	...
	packObjectsCmd.Flags().Bool("exclude-promisor-objects-best-effort", false, "best-effort omit objects that are known to be in the promisor remote")
	...
	packObjectsCmd.Flags().BoolP("quiet", "q", false, "do not show progress meter")
	...
	packObjectsCmd.Flags().String("uri-protocol", "", "generate a corresponding pack index for each specified URI protocol")
