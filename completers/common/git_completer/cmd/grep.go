...
func init() {
	...
	grepCmd.Flags().Bool("and", false, "combine patterns specified with -e using logical AND")
	...
	grepCmd.Flags().BoolP("function-context", "W", false, "show whole surrounding functions of matches")
	...
	grepCmd.Flags().Bool("not", false, "combine patterns with logical NOT")
	...
	grepCmd.Flags().Bool("or", false, "combine patterns with logical OR")
