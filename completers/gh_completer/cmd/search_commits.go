...
func init() {
	...
	search_commitsCmd.Flags().StringSlice("json", []string{}, "Output JSON with the specified `fields`")
	...
	search_commitsCmd.Flags().StringSlice("repo", []string{}, "Filter on repository")
	...
	search_commitsCmd.Flags().StringSlice("visibility", []string{}, "Filter based on repository visibility: {public|private|internal}")
