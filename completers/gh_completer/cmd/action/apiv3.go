...
var v3Paths map[string][]string = map[string][]string{
	"delete": {
		...
		"orgs/{org}/actions/required_workflows/{required_workflow_id}", "Delete a required workflow",
		"orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories/{repository_id}", "Remove a selected repository from required workflow",
		...
		"orgs/{org}/codespaces/billing/selected_users", "Removes users from Codespaces billing for an organization",
		...
		"repositories/{repository_id}/environments/{environment_name}/variables/{name}", "Delete an environment variable",
	...
	"get": {
		...
		"organizations/{org}/personal-access-token-requests", "List requests to access organization resources with fine-grained personal access tokens",
		"organizations/{org}/personal-access-token-requests/{pat_request_id}/repositories", "List repositories requested to be accessed by a fine-grained personal access token",
		"organizations/{org}/personal-access-tokens", "List fine-grained personal access tokens with access to organization resources",
		"organizations/{org}/personal-access-tokens/{pat_id}/repositories", "List repositories a fine-grained personal access token has access to",
		...
		"orgs/{org}/actions/required_workflows", "List required workflows",
		"orgs/{org}/actions/required_workflows/{required_workflow_id}", "Get a required workflow",
		"orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories", "List selected repositories for a required workflow",
		...
		"repos/{org}/{repo}/actions/required_workflows", "List repository required workflows",
		"repos/{org}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}", "Get a required workflow entity for a repository",
		"repos/{org}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}/timing", "Get required workflow usage",
		...
		"repos/{owner}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}/runs", "List workflow runs for a required workflow",
		...
		"repositories/{repository_id}/environments/{environment_name}/variables", "List environment variables",
	...
	"patch": {
		...
		"orgs/{org}/actions/required_workflows/{required_workflow_id}", "Update a required workflow",
		...
		"repositories/{repository_id}/environments/{environment_name}/variables/{name}", "Update an environment variable",
	...
	"post": {
		...
		"organizations/{org}/personal-access-token-requests", "Review requests to access organization resources with fine-grained personal access tokens",
		"organizations/{org}/personal-access-token-requests/{pat_request_id}", "Review a request to access organization resources with a fine-grained personal access token",
		"organizations/{org}/personal-access-tokens", "Update the access to organization resources via fine-grained personal access tokens",
		"organizations/{org}/personal-access-tokens/{pat_id}", "Update the access a fine-grained personal access token has to organization resources",
		"orgs/{org}/actions/required_workflows", "Create a required workflow",
		...
		"orgs/{org}/codespaces/billing/selected_users", "Add users to Codespaces billing for an organization",
		...
		"repos/{owner}/{repo}/pages/deployment", "Create a GitHub Pages deployment",
		...
		"repositories/{repository_id}/environments/{environment_name}/variables", "Create an environment variable",
	...
	"put": {
		...
		"orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories", "Sets repositories for a required workflow",
		"orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories/{repository_id}", "Add a repository to a required workflow",
		...
		"orgs/{org}/codespaces/billing", "Manage access control for organization codespaces",
