...
func init() {
	...
	pub_global_activateCmd.Flags().BoolP("executable", "x", false, "Executable(s) to place on PATH.")
	...
	pub_global_activateCmd.Flags().Bool("overwrite", false, "Overwrite executables from other packages with the same name.")
