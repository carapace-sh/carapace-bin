...
func init() {
	...
	rootCmd.PersistentFlags().String("registry-config", "/home/rsteube/.config/helm/registry.json", "path to the registry config file")
	rootCmd.PersistentFlags().String("repository-cache", "/home/rsteube/.cache/helm/repository", "path to the file containing cached repository indexes")
	rootCmd.PersistentFlags().String("repository-config", "/home/rsteube/.config/helm/repositories.yaml", "path to the file containing repository names and URLs")
