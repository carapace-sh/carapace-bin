...
var macros = map[string]func(string) carapace.Action{
	...
	"net.http.HttpRequestHeaderNames":        func(s string) carapace.Action { return http.ActionHttpRequestHeaderNames() },
	"net.http.HttpRequestHeaders":            func(s string) carapace.Action { return http.ActionHttpRequestHeaders() },
	"net.http.HttpTags":                      func(s string) carapace.Action { return http.ActionHttpTags() },
