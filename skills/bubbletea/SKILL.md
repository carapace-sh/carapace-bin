...
description: >
  ...
  renderer, input handling, program lifecycle, testing, component composition, and integration
  with the Charm ecosystem (lipgloss, bubbles, huh, glamour). Triggers on: "bubbletea",
