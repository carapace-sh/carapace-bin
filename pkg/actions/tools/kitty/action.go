...
func ActionActions() carapace.Action {
	...
	return carapace.ActionValuesDescribed(
		...
		"send_key", "Send the specified keys to the active window (press and release); works only if the program’s keyboard mode supports it.",
